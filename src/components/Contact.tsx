      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-lg leading-relaxed text-text-muted">I&apos;m open to Junior/Associate Software Engineer, AI Engineer, GenAI Engineer, Python Developer, and Full-Stack roles where thoughtful engineering meets real product outcomes.</p><p className="contact-response-note"><span>response expectation</span>I usually respond within 1–2 business days. For role inquiries, include the position and a link to the job description.</p>
