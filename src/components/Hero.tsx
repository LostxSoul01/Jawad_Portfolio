    ...
    <section id="top" className="hero-stage relative flex min-h-screen flex-col justify-center px-6 pt-28 pb-20">
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
        <div>
          ...
          <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="hero-description">I use AI to work smarter—not to outsource ownership. I design, build, and ship production-minded AI, full-stack, and computer-vision products, owning the code, decisions, and quality from idea to deployment.</motion.p>
