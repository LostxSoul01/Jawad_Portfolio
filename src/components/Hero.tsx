    ...
    <section id="top" className="hero-stage relative flex min-h-screen flex-col justify-center px-6 pt-28 pb-20">
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
        <div>
          ...
          <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="hero-description">I help people turn complex ideas into clear, efficient digital products through thoughtful design and reliable engineering. I use AI where it creates real leverage, while staying accountable for the code, decisions, and quality from first concept to final deployment.</motion.p>
